 ...
 *
 * This class registers custom post types required for Alsiha Theme.
 *
 * @package Al-Siha
 * @since   1.0.0
 */
...
class Alsiha_Post_Types {
	...
	private function define_post_types() {
		$this->custom_post_types = array(
			// array(
			// 	'name'   => __( 'Gallery', 'alsiha' ),
			// 	'slug'   => 'alsiha_gallery',
			// 	'labels' => array(
			// 		'all_items' => __( 'All Galleries', 'alsiha' ),
			// 	),
			// 	'args'   => array(
			...
			// array(
			// 	'name'   => __( 'Testimonials', 'alsiha' ),
			// 	'slug'   => 'alsiha_testimonial',
			// 	'labels' => array(
			// 		'all_items' => __( 'All Testimonials', 'alsiha' ),
			// 	),
			// 	'args'   => array(
			// 		'publicly_queryable' => false,
			// 		'has_archive'        => false,
