...
class Alsiha_Pagination {
	...
	private function nav_wrapper() {
		$this->render_nav = '<nav id="post-navigation" class="navigation post-navigation" aria-label="' . esc_html__( 'Post navigation', 'alsiha' ) . '">' . $this->render_nav . '</nav><!-- #post-navigation -->';
