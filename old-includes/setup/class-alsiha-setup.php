...
class Alsiha_Setup {
	...
	public function theme_setup_core() {
		 ...
		 * If you're building a theme based on Alsiha Theme, use a find and replace
		 * to change 'alsiha' to the name of your theme in all the template files.
		 */
