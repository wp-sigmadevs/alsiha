...
class Mfit_Pagination {
	...
	private function screen_reader_text() {
		return '<h2 class="screen-reader-text">' . esc_html__( 'Post navigation', 'maxx-fitness' ) . '</h2>';
	}
	...
	private function nav_wrapper() {
		$this->render_nav = '<nav id="post-navigation" class="navigation post-navigation" aria-label="' . esc_html__( 'Post navigation', 'maxx-fitness' ) . '">' . $this->render_nav . '</nav><!-- #post-navigation -->';
