...
use SigmaDevs\AlSiha\Common\Abstracts\Base;
use SigmaDevs\AlSiha\Common\Traits\Singleton;
...
final class Setup {
	...
	public function registerThemeSupports() {
		...
		add_theme_support(
			'post-formats',
			apply_filters(
				'sd/alsiha/registered_post_formats',
				[
					'gallery',
					'audio',
					'video',
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'sd/alsiha/custom_background_args',
				[
	...
	public function registerImageSizes() {
		$imageSizes = apply_filters(
			'sd/alsiha/registered_image_sizes',
			[
