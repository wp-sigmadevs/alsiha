	...
	public function register_taxonomy() {
		...
		$labels = array_merge(
			...
			array(
				...
				'name'              => sprintf( esc_html_x( '%s', 'taxonomy general name', 'alsiha' ), $plural ),
				/* translators: %s: taxonomy singular name */
				'singular_name'     => sprintf( esc_html_x( '%s', 'taxonomy singular name', 'alsiha' ), $name ),
				/* translators: %s: taxonomy plural name */
				...
				'menu_name'         => sprintf( esc_html__( '%s', 'alsiha' ), $menu_name ),
			),
			// Given labels.
