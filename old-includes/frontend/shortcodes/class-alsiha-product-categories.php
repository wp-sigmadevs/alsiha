 ...
 * @since  1.0.0
 */
class Alsiha_Product_Categories {
	...
	public function shortcode( $atts ) {
		...
		if ( Alsiha_Helpers::inside_top_product_cat() && ! Alsiha_Helpers::inside_product_attribute() ) {
		...
		} elseif ( Alsiha_Helpers::inside_product_cat() ) {
			$parent = $page->parent;
			$args   = array(
				'parent' => $parent,
			);
