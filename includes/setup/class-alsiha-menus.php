...
class Mfit_Menus {
	...
	public function register_menus() {
		$args = array(
			'primary_nav'   => esc_html__( 'Primary Navigation Menu', 'maxx-fitness' ),
			'secondary_nav' => esc_html__( 'Secondary (Icon) Navigation Menu', 'maxx-fitness' ),
			'handheld_nav'  => esc_html__( 'Mobile Navigation Menu', 'maxx-fitness' ),
		);
