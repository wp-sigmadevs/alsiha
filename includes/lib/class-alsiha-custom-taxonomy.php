	...
	public function register_taxonomy() {
		...
		$labels = array_merge(
			...
			array(
				...
				'name'              => sprintf( esc_html_x( '%s', 'taxonomy general name', 'maxx-fitness' ), $plural ),
				/* translators: %s: taxonomy singular name */
				'singular_name'     => sprintf( esc_html_x( '%s', 'taxonomy singular name', 'maxx-fitness' ), $name ),
				/* translators: %s: taxonomy plural name */
				'search_items'      => sprintf( esc_html__( 'Search %s', 'maxx-fitness' ), $plural ),
				/* translators: %s: taxonomy plural name */
				'all_items'         => sprintf( esc_html__( 'All %s', 'maxx-fitness' ), $plural ),
				/* translators: %s: taxonomy name */
				'parent_item'       => sprintf( esc_html__( 'Parent %s', 'maxx-fitness' ), $name ),
				/* translators: %s: taxonomy name */
				'parent_item_colon' => sprintf( esc_html__( 'Parent %s:', 'maxx-fitness' ), $name ),
				/* translators: %s: taxonomy name */
				'edit_item'         => sprintf( esc_html__( 'Edit %s', 'maxx-fitness' ), $name ),
				/* translators: %s: taxonomy name */
				'update_item'       => sprintf( esc_html__( 'Update %s', 'maxx-fitness' ), $name ),
				/* translators: %s: taxonomy name */
				'add_new_item'      => sprintf( esc_html__( 'Add New %s', 'maxx-fitness' ), $name ),
				/* translators: %s: taxonomy name */
				'new_item_name'     => sprintf( esc_html__( 'New %s Name', 'maxx-fitness' ), $name ),
				/* translators: %s: taxonomy modified name */
				'menu_name'         => sprintf( esc_html__( '%s', 'maxx-fitness' ), $menu_name ),
			),
			// Given labels.
