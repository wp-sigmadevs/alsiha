...
class Templates {
	...
	public function get( $slug, $name = null, $args = [], $load = true ) {
		...
		do_action( 'sd/alsiha/get_template_part_' . $slug, $slug, $name, $args );
	...
	protected function getFileNames( $slug, $name, $args ) {
		 ...
		 * @since 1.0.0
		 */
		return apply_filters( 'sd/alsiha/get_template_part', $templates, $slug, $name, $args );
	}
	...
	protected function getPaths() {
		 ...
		 * @since 1.0.0
		 */
		$filePaths = apply_filters( 'sd/alsiha/template_paths', $filePaths );
